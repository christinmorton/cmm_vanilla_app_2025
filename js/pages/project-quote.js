console.log('💼 PROJECT-QUOTE.JS LOADED - Project quote page specific functionality');

// Import page-specific functionality for project-quote.html
import DesignGridWindow from '../modules/DesignGridTypes/index.js';
import ProjectQuotePage from '../modules/ProjectQuotePage.js';
...
// Initialize project quote page functionality
const initProjectQuotePage = async () => {
  console.log('Initializing project quote page functionality...');
  ...
  // Configure canvas based on template (project-quote.html uses "hybrid" template)
  ...
  window.pageTransitionHandlers.push(() => {
    console.log('Project quote page transition handler');
    // ProjectQuotePage module handles its own state management
  });

  console.log('✅ Project quote page functionality initialized');
};

// Hybrid mode functionality (for project-quote.html)
...
initProjectQuotePage().catch(console.error);